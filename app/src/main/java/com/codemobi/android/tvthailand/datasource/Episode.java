...
import com.codemobi.android.tvthailand.utils.Base64;
import com.codemobi.android.tvthailand.utils.Utils;
...
public class Episode implements Serializable {
	...
	public Episode(Context c, String id, int ep, String title,
		...
		this.date = String.format(c.getString(com.codemobi.android.tvthailand.R.string.aired),
				dateToFormat(date));
		...
		if (this.ep > 20000000) {
			...
			displayBuilder.append(String.format(c.getString(com.codemobi.android.tvthailand.R.string.episode),
					this.ep));
			if (!title.equals("")) {
				displayBuilder.append(" - " + title);
			}
