 ...
 */
public class VitamioTrackingVideoView extends VideoView implements OnCompletionListener, OnErrorListener {
  ...
  public VitamioTrackingVideoView(Context context) {
    super(context);
