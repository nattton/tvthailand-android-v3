...
public class YoutubePlayerViewActivity extends YouTubeFailureRecoveryActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.codemobi.android.tvthailand.R.layout.youtube_playerview);
		...
		YouTubePlayerView youTubeView = (YouTubePlayerView) findViewById(com.codemobi.android.tvthailand.R.id.youtube_view);
...
//	    	Toast.makeText(this, "portrait", Toast.LENGTH_SHORT).show();
	...
	protected YouTubePlayer.Provider getYouTubePlayerProvider() {
		return (YouTubePlayerView) findViewById(com.codemobi.android.tvthailand.R.id.youtube_view);
	}
